/*
Name: B站，腾讯视频，去除app下载
Match Type: Domain
Domain: .*\.bilibili\.com
Match Time: DOMContentLoaded
Source: http://via-app.cn
*/
...
if (window.md5(current_host) == "6d256804756115551da4d04e903b6bb0") {
  ...
  let app_btns_regex = ["a[open-app]", 'div[class^="launch-app-btn"]'];
  setInterval(() => {
  ...
  s.innerHTML =
    ".wings-disabled { padding-left: 12px; padding-right: 12px; pointer-events:none; } .fe-ui-open-app-btn-disabled { display: inline-block; position: relative; pointer-events:none; } .open-app-btn-disabled { display: inline-block; position: relative; pointer-events:none; }";
  ...
  setInterval(() => {
    ...
    for (let e of document.getElementsByClassName(
      "launch-app-btn v-card-toapp",
    )) {
      if (e.getAttribute("data-aid")) {
        e.firstElementChild.href =
          "https://" + current_host + "/video/av" + e.getAttribute("data-aid");
      }
    }
    ...
    document.getElementById("comment") &&
      (document.getElementById("comment").style = "pointer-events:none;");
  }, 300);
}
